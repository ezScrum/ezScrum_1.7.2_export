...
-- 正在導出表  ezscrum_172.ezscrum_story_relation 的資料：19 rows
...
-- 正在導出表  ezscrum_172.mantis_bug_file_table 的資料：4 rows
...
-- 正在導出表  ezscrum_172.mantis_bug_history_table 的資料：38 rows
