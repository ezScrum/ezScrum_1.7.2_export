...
//	private static Log log = LogFactory.getLog(ModifyAccountAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		UserInformation userInformation = new UserInformation(id, realName, password, email, enable);
		...
		if (Boolean.valueOf(isEdit)) {
			newAccount = ah.updateAccount(session, userInformation);
			...
			//	新增帳號
			newAccount = ah.createAccount(userInformation, roles);
		}
