...
/*	private void cleanActionInformation(){
	...
	/**
	 * 測試admin登入專案後，是否能取得正確的該專案的Taskboard資訊。
	 * response text : {"ID":"0","SprintGoal":"","Current_Story_Undone_Total_Point":"","Current_Task_Undone_Total_Point":""}
	 */
	...
	/**
	 * 測試一般使用者登入專案後，該專案在沒有任何的sprint進行的情況下，是否能取得正確的Taskboard資訊。
	 * response text : {"ID":"0","SprintGoal":"","Current_Story_Undone_Total_Point":"","Current_Task_Undone_Total_Point":""}
	 */
