...
public class ShowSprintInformationActionTest extends MockStrutsTestCase {
    ...
    public void testShowInformationAction_2(){
		...
		Date endDate =  testTool.getSprintEndDate(CreateSprint.SPRINT_INTERVAL, startDate);
    ...
    public void testShowInformationAction_3() throws Exception{
		...
		/**
		 * 1. verify sprint ID
		 * 2. verify story information
		 * 3. verify sprint plan information
		 * 5. verify Sprint週期
		 * 6. verify 參與此專案的人
		 */
		//	verify sprint ID
    ...
    public void testShowInformationAction_4(){
		...
		// ================ set session info ========================
		UserSession newUser = new UserSession(createAccount.getAccountList().get(0));
