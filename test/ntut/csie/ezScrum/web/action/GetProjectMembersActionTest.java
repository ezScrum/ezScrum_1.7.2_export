...
public class GetProjectMembersActionTest extends MockStrutsTestCase {
	 ...
	 * 正常狀態，新增一名帳號至專案
	 */
	public void testGetProjcetMembers1() {
	...
	public void testGetProjcetMembers3() throws Exception {
		...
		ah.assignRole_remove(config.getUserSession(), CA.getAccountList().get(0).getID(), CP.getProjectList().get(0).getName(), ScrumEnum.SCRUMROLE_PRODUCTOWNER);
